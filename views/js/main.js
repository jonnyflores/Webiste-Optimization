...
//With pizzasDiv underneath the var pizzasDiv the DOM doesn't have to get called so much
...
function updatePositions() {
  ...
  window.performance.mark("mark_start_frame");
    ...
    //Removed the querySelector since that was adding extra loading time and replaced with a getElementsByClassName instead
    var items = document.getElementsByClassName('mover');

  //moved the scrollTop value outside of the for loop
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
//The winoow height will decide how many pizzas get loaded
//Replaced the querySelector originally placed here to also reduce the amount of time it was being called
  var lines = Math.round(window.screen.height / s);
  var pizzaNumbers = lines * cols;
  var movingPizzas = document.getElementById("movingPizzas1");
  for (var i = 0; i < pizzaNumbers; i++) {
